...
def reverse_string(str) # str = "friends"
  return '' if str.length == 0
  return str[-1] + reverse_string(str[0...-1]) # s + d + n + revers_str("frie")
end
...
def flatten(data)
    ...
    # data = [ele,le,le,le] # 2nd to last ite
    # return data.map do |ele|
    #   n
    #   if ele.is_a?(Array)
    #     *ele
    # end
